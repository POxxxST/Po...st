...
class MyCalculator(QWidget):
    ...
    def Menu(self):
        ...
        self.btnMax = JointButton.Example()
        self.vboxBot.addWidget(self.btnMax, stretch=1)
        self.btnMax.btn_clicked.connect(self.handle_key_press)

        self.btnProg = JointButton.ExampleProg()
        self.vboxBot.addWidget(self.btnProg)
        self.btnProg.btn_clicked.connect(self.handle_key_press)

        self.btnGeo = JointButton.ExampleGeomet()
        self.vboxBot.addWidget(self.btnGeo)
        self.btnGeo.btn_clicked.connect(self.handle_key_press)
...
class State1:
    ...
    def change_edit(self, key):
        ...
        if text == '0':
            ...
            self.calc.line_edit.l_edit.setText(key)
        elif self.calc.result == self.calc.line_edit.l_edit.text():
    ...
    def change_edit(self, key):
        ...
        if self.calc.switchOper:
            if text == '+' or text == '-' or text == '/' or text == '*' or text == '**' or text == '':
                pass
            elif self.calc.switchOper2:
                self.calc.state = State3(self.calc)
                self.calc.state.handle('=')
...
class State4:
    ...
    def change_edit(self, key):
        if key == 'bin' and self.calc.switchSt4:
            ...
            text = int(float(self.calc.line_edit.l_edit.text()))
            self.calc.result = str(math.cos(text))
            self.calc.switchOper = True
            self.calc.switchOper2 = True
            self.calc.switchSt4 = True
            self.calc.switch = False
            ...
            text = int(float(self.calc.line_edit.l_edit.text()))
            self.calc.result = str(math.sin(text))
            self.calc.switchOper2 = True
            self.calc.switchOper = True
            self.calc.switchSt4 = True
            self.calc.switch = False
            ...
            text = int(float(self.calc.line_edit.l_edit.text()))
            self.calc.result = str(math.tan(text))
            self.calc.switchOper2 = True
            self.calc.switchOper = True
            self.calc.switchSt4 = True
            self.calc.switch = False
            ...
            text = int(float(self.calc.line_edit.l_edit.text()))
            self.calc.result = str(math.factorial(text))
            self.calc.switchOper = True
            self.calc.switchOper2 = True
            self.calc.switchSt4 = True
            self.calc.switch = False
